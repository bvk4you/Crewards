...
struct HDFCRegalia {
    ...
    func create()->Void{
            var newCard = Card(
                title: "Regalia",id: 3,gracePeriod: "20-50", bank: "HDFC", interestPerMonth: 2.5,creditLimit: 0,

                      partners: [],
                      contactLess: true,
                      eligibility: Eligibility(income: 0, ITR: 0, description: "N/A"),
                      brand: ["visa","master"],
                      categories: [CardCategory.grocery,CardCategory.shopping,CardCategory.hotels],
                      tier: ["premium"],
                      ...
                      rewards: RewardRate(entertainment:2.5, grocery: 2.5, shopping: 0, food: 2.5, travel: 0, others: 0.5,minRate:3.3,maxRate:10,utilityBills:5,expiryTime:0),

                      benefits: [BenefitsCategory.loungeacess],
                benefitsDetails: Benefits(                           vouchers:[Voucher(brand: "Welcome Gift", description: "Welcome e-gift Voucher worth Rs. 3,000 from any of the following brands: Bata/Hush Puppies, Pantaloons, Aditya Birla Fashion, Shoppers Stop and Yatra.com", value:3000.0,isMilestoneLinked: false),
                      ...
                      gradientColor:[BrandColor(r: 0.682, g: 0.301, b: 1, alpha: 1.0),
                      BrandColor(r: 0.149, g: 0.247, b: 0.623, alpha: 1.0)]

                      )
        let newCityRef = db.collection("Cards").document("HDFC Regalia")
