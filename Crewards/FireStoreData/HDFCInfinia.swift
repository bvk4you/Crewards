    ...
    func create()->Void{
            var newCard = Card(
                title: "Infinia",id: 2,gracePeriod: "20-50", bank: "HDFC", interestPerMonth: 1.99,creditLimit: 0,
                      ...
                      brand: ["visa","master"],
                      categories: [CardCategory.grocery,CardCategory.flights,CardCategory.hotels,CardCategory.insurance],
                      tier: ["premium"],
                ...
                rewards: RewardRate(entertainment:2.5, grocery: 2.5, shopping: 0, food: 2.5, travel: 0, others: 0.5,minRate:3.3,maxRate:33.0,utilityBills:5,expiryTime:0),
