...
struct SBIPrime {
    ...
    func create()->Void{
        var newCard = Card(
            ...
            rewards: RewardRate(entertainment:2.5, grocery: 2.5, shopping: 0.5, food: 2.5, travel: 0.5, others: 0.5,minRate:0.5,maxRate:5.0,utilityBills:5,expiryTime:0),
