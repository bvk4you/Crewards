...
struct HDFCDinersBlack {
    ...
    func create()->Void{
            var newCard = Card(
                title: "Diners Black",id: 6,gracePeriod: "20-50", bank: "HDFC", interestPerMonth: 3.0,creditLimit: 0,

                      partners: [],
                      contactLess: true,
                      eligibility: Eligibility(income: 0, ITR: 0, description: "N/A"),
                      brand: ["visa","master"],
                      categories: [CardCategory.flights,CardCategory.hotels,CardCategory.insurance],
                      tier: ["premium"],
                      ...
                      rewards: RewardRate(entertainment:2.5, grocery: 2.5, shopping: 0, food: 2.5, travel: 0, others: 0.5,minRate:2.0,maxRate:15,utilityBills:5,expiryTime:0),

                benefits: [BenefitsCategory.vouchers,BenefitsCategory.loungeacess],
