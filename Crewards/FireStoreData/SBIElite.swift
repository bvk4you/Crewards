    ...
    func create()->Void{
            let newCard = Card(
                title: "Elite",id: 8,gracePeriod: "20-50", bank: "SBI", interestPerMonth: 3.45,creditLimit: 0,
                      ...
                      brand: ["visa","master"],
                      categories: [CardCategory.grocery,CardCategory.shopping,CardCategory.flights,CardCategory.insurance],
                      tier: ["premium"],
                      ...
                      rewards: RewardRate(entertainment:2.5, grocery: 2.5, shopping: 0, food: 2.5, travel: 0, others: 0.5,minRate:1.0,maxRate:5,utilityBills:5,expiryTime:0),
