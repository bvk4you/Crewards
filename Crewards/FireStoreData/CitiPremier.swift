...
struct CitiPremierMiles {
    let db  = Firestore.firestore()

    func create()->Void{
            var newCard = Card(
                title: "Premier Miles",id: 5,gracePeriod: "20-50", bank: "CITI", interestPerMonth: 2.25,creditLimit: 0,
        ...
        let newCityRef = db.collection("Cards").document("Citi Premier")
